...
export default function HeroBackground() {
  return (
    <div className="pointer-events-none absolute inset-0 z-0 flex justify-center overflow-visible">
      <div className="relative w-full max-w-[1600px] h-full">
        ...
        {/* The main hero graphic, anchored to the right of the container */}
        <div
          id="hero-background-svg"
          className="absolute top-[360px] sm:top-[330px] right-0 h-[600px] w-full max-w-[800px] opacity-90 contrast-[.95] scale-150 -rotate-12 sm:scale-100 sm:rotate-0 lg:top-0 lg:h-[1000px] lg:right-auto lg:left-[30%] lg:w-[1250px] lg:max-w-none lg:translate-x-0"
        >
        <img
