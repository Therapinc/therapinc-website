...
export default function HeroContent() {
  return (
    <div className="relative z-10 max-w-4xl">
      ...
      <div className="animate-fade-in-up mt-[var(--spacing-lg)] font-sans text-lg leading-relaxed text-gray-600 delay-100 sm:text-xl">
        <p className="font-semibold text-gray-800">Empowering Growth. Enriching Lives.</p>
        <p className="mt-3">
